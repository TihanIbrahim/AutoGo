...
def create_zahlung(
    ...
    current_user: User = Depends(owner_required)  # Only Owner can create from dashboard
):
    ...
    # Verify the related contract exists
    ...
    # Ensure payment date is after contract start
